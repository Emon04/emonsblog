                    ...
                    <div class="main-post">
                        ...
                        <div class="blog-post-inner">
                            ...
                            <div class="post-info">
                                ...
                                <div class="left-area">
                                    <a class="avatar" href="#"><img @isset(Auth::user()->image) src="{{url(asset('storage/profile/'.Auth::user()->image))}}"@endisset alt="Profile Image"></a>
                                </div>
                                ...
                                <div class="blog-info">
                                    ...
                                    <ul class="post-footer">
                                        <li>
                                            ...
                                            @else
                                                <a href="javascript:void(0);" onclick="document.getElementById('favorite-form-{{$randompost->id}}').submit();"><i class="ion-heart"></i>{{$randompost->favorite_to_users->count()}}</a>
                                                <form method="POST" action="{{ route('post.favorite', $randompost->id) }}" style="display: none;" id="favorite-form-{{$randompost->id}}">
                                                    @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="comment-form">
                        @guest
                            <p>
                                For comment, you need to login first.
